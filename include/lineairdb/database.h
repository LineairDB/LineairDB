...
>>>>>>> main
    ...
    bool CreateSecondaryIndex(const std::string table_name, const std::string index_name, const SecondaryIndexOption::Constraint constraint = SecondaryIndexOption::Constraint::NONE);
