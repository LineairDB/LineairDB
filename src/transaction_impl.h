...
class Transaction::Impl {
 ...
 public:
  ...
  /* std::optional<std::pair<const std::byte* const, const size_t>>
     ReadSecondaryIndex(const std::string_view table_name, const
     std::string_view index_name, const std::string_view secondary_key);  */
